...
from keras.layers import Dropout, Flatten, Convolution2D, MaxPooling2D, ZeroPadding2D, Dense, Activation, LSTM
...
model.fit(X_train, y_train, nb_epoch=nb_epoch, batch_size=batch_size, verbose = 1, 
    validation_data=(X_valid, y_valid), shuffle=True, callbacks=[TensorBoard(log_dir='fish1'), checkpointer])
